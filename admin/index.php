...
$subscriber_count = mysqli_num_rows($select_all_subscriber);
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          $element_text =['All posts', 'Active post', 'Draft post', 'Comments', 'Pending comments', 'Users','Subscriber', 'Categories'];
          $element_count =[$post_count, $post_publish_count, $post_draft_count, $comment_count,$unapproved_comment_count, $user_count, $subscriber_count, $category_count];
